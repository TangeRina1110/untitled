...
public class task {
    ...
    public static void main(String[] args) {
        ...
        students[0] = new Student("Petrov", 18, 106, 4);
        students[1] = new Student("Ivanov", 14, 103, 2);
        students[2] = new Student("Sidorova", 26, 102, 5);
        ...
        students_1[0] = new Student("Gusev", 22, 105, 1);
        students_1[1] = new Student("Baranova", 20, 103, 7);
        students_1[2] = new Student("Lukashik", 26, 102, 3);
